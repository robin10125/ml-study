/* PPO course — navigation, problem-set engine, progress tracking */

const CHAPTERS = [
  { file: "index.html", title: "Course Home", short: "Home" },
  { file: "ch1.html", title: "1 · MDPs, Returns & Value Functions", short: "Ch 1" },
  { file: "ch2.html", title: "2 · The Policy Gradient Theorem", short: "Ch 2" },
  { file: "ch3.html", title: "3 · Baselines, Advantages & GAE", short: "Ch 3" },
  { file: "ch4.html", title: "4 · The Step-Size Problem & Surrogates", short: "Ch 4" },
  { file: "ch5.html", title: "5 · TRPO: Trust Region Policy Optimization", short: "Ch 5" },
  { file: "ch6.html", title: "6 · PPO: The Clipped Surrogate", short: "Ch 6" },
  { file: "ch7.html", title: "7 · Building PPO from Scratch", short: "Ch 7" },
];
...
function quizKey(page, i) { return "ppo-progress:" + page + ":" + i; }
function totalKey(page) { return "ppo-total:" + page; }
function workKey(page, i) { return "ppo-work:" + page + ":" + i; }
...
function buildSidebar() {
  ...
  sb.id = "sidebar";
  let html =
    '<a class="brand" href="index.html"><span class="bolt">&#127919;</span> Proximal Policy Optimization</a>' +
    '<div class="tagline">from REINFORCE to TRPO to PPO, rigorously</div>';
...
function enhanceQuizzes() {
  ...
  quizzes.forEach((q, i) => {
    ...
    ta.placeholder = q.dataset.placeholder ||
      "Write your solution here — the derivation line by line, or real code.";
