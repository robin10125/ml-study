/* Flash Attention course — navigation, problem-set engine, progress tracking */

const CHAPTERS = [
  { file: "index.html", title: "Course Home", short: "Home" },
  { file: "ch1.html", title: "1 · Attention & the Memory Wall", short: "Ch 1" },
  { file: "ch2.html", title: "2 · GPU Architecture & CUDA Basics", short: "Ch 2" },
  { file: "ch3.html", title: "3 · Safe & Online Softmax", short: "Ch 3" },
  { file: "ch4.html", title: "4 · The FlashAttention-2 Algorithm", short: "Ch 4" },
  { file: "ch5.html", title: "5 · FA-2 Forward Pass in CUDA", short: "Ch 5" },
  { file: "ch6.html", title: "6 · The Backward Pass", short: "Ch 6" },
  { file: "ch7.html", title: "7 · Flash Attention in JAX", short: "Ch 7" },
];
...
function quizKey(page, i) { return "fa-progress:" + page + ":" + i; }
function totalKey(page) { return "fa-total:" + page; }
function workKey(page, i) { return "fa-work:" + page + ":" + i; }
...
function buildSidebar() {
  ...
  sb.id = "sidebar";
  let html =
    '<a class="brand" href="index.html"><span class="bolt">&#9889;</span> Flash Attention</a>' +
    '<div class="tagline">from first principles to CUDA &amp; JAX</div>';
...
/* ---------- problem-set engine ----------
   Each .quiz block is one problem: a statement (.q-text), an editable
...
function enhanceQuizzes() {
  ...
  quizzes.forEach((q, i) => {
    ...
    ta.spellcheck = false;
    const hasCode = !!q.querySelector(".q-text pre code");
    ta.placeholder = q.dataset.placeholder ||
      (hasCode
        ? "# Write your solution here. Run code answers in a real file or REPL."
        : "Write your answer here before opening the reference.");
